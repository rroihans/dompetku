        ...
        <div className="space-y-6 max-w-full overflow-hidden">
                            ...
                            <CardContent className="pt-0">
                                <div className="mt-4 grid grid-cols-2 gap-2">
                                    <Link href={`/transaksi?akunId=${account.id}&search=${encodeURIComponent(account.nama)}`}>
                                        <Button variant="outline" size="sm" className="w-full h-9 overflow-hidden">
                                            <History className="w-3.5 h-3.5 shrink-0" />
                                            <span className="truncate">Riwayat</span>
                                        </Button>
                                    </Link>
                                    {account.tipe === 'CREDIT_CARD' ? (
                                        <Link href="/cicilan">
                                            <Button variant="outline" size="sm" className="w-full h-9 overflow-hidden">
                                                <CreditCard className="w-3.5 h-3.5 shrink-0" />
                                                <span className="truncate">Cicilan</span>
                                            </Button>
                                        </Link>
                                    ) : (
                                        <Link href="/transaksi">
            ...
            {pagination.totalPages > 1 && (
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {currentPage > 1 ? (
                            <Link href={`/akun?page=${currentPage - 1}`}>
