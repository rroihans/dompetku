...
// Version 6: Add isDummy index for all tables
        this.version(6).stores({
            akun: "id, nama, tipe, biayaAdminAktif, isDummy, createdAt, updatedAt",
            transaksi: "id, tanggal, kategori, nominalInt, debitAkunId, kreditAkunId, rencanaCicilanId, idempotencyKey, isDummy, [tanggal+id], [kategori+tanggal], [debitAkunId+tanggal], [kreditAkunId+tanggal]",
            rencanaCicilan: "id, status, tanggalJatuhTempo, akunKreditId, akunDebitId, isDummy, createdAt",
            recurringTransaction: "id, akunId, frekuensi, aktif, terakhirDieksekusi, isDummy, createdAt",
            budget: "id, kategori, isDummy, [bulan+tahun]",
            netWorthSnapshot: "id, tanggal, isDummy",
            currencyRate: "id, [kodeAsal+kodeTujuan], tanggalUpdate, isDummy",
            appSetting: "id, kunci, updatedAt, isDummy",
            adminFee: "id, akunId, isActive, recurringTxId, isDummy",
            installmentTemplate: "id, bankName, isActive, isDummy",
            notification: "id, read, createdAt, isDummy",
            filterPreset: "id, name, usageCount, isDummy",
            accountTemplate: "id, nama, tipeAkun, isActive, isDummy",
            templateTransaksi: "id, nama, kategori, tipeTransaksi, akunId, usageCount, isDummy",
            logSistem: "id, level, modul, createdAt, isDummy",
            kategori: "id, nama, parentId, nature, show, order, isDummy, createdAt",

            summaryMonth: "id, month, isDummy",
            summaryCategoryMonth: "id, month, kategori, isDummy",
            summaryHeatmapDay: "id, tanggal, isDummy",
            summaryAccountMonth: "id, month, akunId, isDummy",
            archivePeriod: "id, archived, createdAt, isDummy",
        });
    }
}
